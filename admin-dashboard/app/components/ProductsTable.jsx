      ...
      <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 md:gap-0">
        ...
        <div className="relative w-full md:w-auto">
          <input
            ...
            value={searchTerm}
            className="bg-[#2f2f2f] text-white placeholder:text-gray-400 rounded-lg pl-10 pr-4 py-2 w-full md:w-64 focus:outline-none focus:ring-2 focus:ring-gray-500 transition duration-200 text-sm"
          />
                    ...
                    {["price", "stock", "sales"].map((field) => (
                      <div key={field}>
                        ...
                        {editingRow === product.id ? (
                          ...
                          `$${Number(product[field]).toFixed(2)}`
                        ) : (
                          product[field]
                        )}
                      </div>
