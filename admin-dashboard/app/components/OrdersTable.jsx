                ...
                <td className="md:hidden px-3 py-2">
                  ...
                  <div className="mt-2 text-xs text-gray-300">
                    ...
                    <div className="flex items-center gap-1">
                      Status:
                      <span
                        className={`px-2 inline-flex text-xs font-semibold rounded-full ${order.status === "Delivered" ? "bg-green-400 text-green-800" : order.status === "Pending" ? "bg-yellow-400 text-yellow-800" : "bg-red-400 text-red-800"}`}
                      >
                        {order.status}
                      </span>
                    </div>
